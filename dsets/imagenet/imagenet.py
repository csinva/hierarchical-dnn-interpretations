...
def pred_ims(model, ims):
    # if missing batch dimension, pad with 1
    if len(ims.shape) == 3:
    ...
    # todo - build in softmax support (logits = model.logits(t))
...
def get_im_and_label(num, train=False):
    ...
    if train:
        ...
        _, data_loader = load_data()  # train_loader, val_loader = load_data()
