...
data = data.replace('<h1 class="title">Module <code>acd</code></h1>', '') # remove header
data = data.replace('Module for computing hierarchical interpretations of neural network predictions', '')
